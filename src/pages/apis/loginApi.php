...
function sessionEmprendimiento($fila,$mysqli,$result1){
  ...
  FROM `emprendimientos` WHERE `Id_Usuario` = $fila[0]";
    ...
    $datosSesionEmprendimiento = array('identificador' => $filaEmprendimiento[0],'nombreEmprendimiento' => $filaEmprendimiento[1],
    'categoria' => $filaEmprendimiento[2],'validacionEmprendimiento' => $filaEmprendimiento[3]);
